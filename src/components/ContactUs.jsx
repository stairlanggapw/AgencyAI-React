...
const ContactUs = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "0ac1b35b-46c6-4a6c-8802-53ea6effa556");
      ...
      <Title title='Reach out to us' desc='From strategy to execution, we craft digital solutions that move your business forward.'/>
        ...
        onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
            ...
            <div className='sm:col-span-2'>
                ...
                <textarea name="message" rows={8} placeholder='Enter your massage' className='w-full p-3 text-sm outline-none rounded-lg border border-gray-300 dark:border-gray-600' required/>
            </div>
